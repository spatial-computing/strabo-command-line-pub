...
<qgis version="2.4.0-Chugiak" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="singleSymbol">
    <symbols>
      <symbol alpha="0.462745" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="179,109,112,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="  concat (NameAfterDictionary,'/',NameBeforeDictionary)"/>
    ...
    <property key="labeling/xOffset" value="5"/>
    <property key="labeling/yOffset" value="5"/>
  </customproperties>
  <blendMode>0</blendMode>
  <featureBlendMode>0</featureBlendMode>
  <layerTransparency>0</layerTransparency>
  <displayfield>NameAfterDictionary</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" name="NameAfterDictionary"/>
    <edittype labelontop="0" editable="1" name="NameBeforeDictionary"/>
    <edittype labelontop="0" editable="1" name="ImageId"/>
  </edittypes>
  <editform></editform>
